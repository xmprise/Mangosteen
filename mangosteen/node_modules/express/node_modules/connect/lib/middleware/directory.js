...
exports.html = function(req, res, files, next, dir, showUp, icons){
  fs.readFile(__dirname + '/../static/directory.html', 'utf8', function(err, str){
    if (err) return next(err);
    fs.readFile(__dirname + '/../static/style.css', 'utf8', function(err, style){
      if (err) return next(err);
...
function load(icon) {
  ...
  return cache[icon] = fs.readFileSync(__dirname + '/../static/icons/' + icon, 'base64');
}
