...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cc=/root/android-toolchain/bin/arm-linux-androideabi-gcc --cross-prefix=/root/android-toolchain/bin/arm-linux-androideabi- --extra-cflags='-marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-Wl,--fix-cortex-a8' --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-network --disable-devices --enable-gpl --enable-encoder=h264 --enable-libx264
prefix=/usr/local
...
SRC_PATH="/home/jbj/workspace/FFmpegBasic/jni/ffmpeg"
SRC_PATH_BARE=/home/jbj/workspace/FFmpegBasic/jni/ffmpeg
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=/root/android-toolchain/bin/arm-linux-androideabi-gcc
AS=/root/android-toolchain/bin/arm-linux-androideabi-gcc
LD=/root/android-toolchain/bin/arm-linux-androideabi-gcc
DEPCC=/root/android-toolchain/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/root/android-toolchain/bin/arm-linux-androideabi-ar
RANLIB=/root/android-toolchain/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/root/android-toolchain/bin/arm-linux-androideabi-strip
...
ASFLAGS= -marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon  -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,--fix-cortex-a8 -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,libpostproc -Wl,-rpath-link,libswscale -Wl,-rpath-link,libavfilter -Wl,-rpath-link,libavdevice -Wl,-rpath-link,libavformat -Wl,-rpath-link,libavcodec -Wl,-rpath-link,libavutil
...
LAVF_TESTS=aiff alaw asf au avi bmp dv_fmt ffm flv_fmt gif gxf jpg mkv mmf mov mpg mulaw mxf mxf_d10 nut ogg pbmpipe pcx pgm pgmpipe pixfmt png ppm ppmpipe rm sgi swf tga tiff ts voc voc_s16 wav yuv4mpeg 
