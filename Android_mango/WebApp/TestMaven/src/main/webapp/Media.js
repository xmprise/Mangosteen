var Media = 
{
        ...
        {
            var uri =  "/Mangosteen/rest/media/" + type + "/" + location;
        ...
        renderMedia: function (type, location)
        {
            ...
            for (var itemidx in lmedia)
            {
                ...
                if (type == "image")
                {
                    html += "<div class='float'><a target='_blank' href='/Mangosteen/browse/media/" + item.type + "/" + item.location + "/" + item.id + 
                          "'><div class='thumb'>&nbsp;<img src='/Mangosteen/browse/media/" + item.type + "/" + item.location + "/thumb/" + item.id + "' alt='" + 
                          item.title + "'/>&nbsp;</div></a><p>" + item.title + "</p></div>";
                }
                else if (type == "audio")
                {
                    html += "<div class='float'><a href='/Mangosteen/browse/media/" + item.type + "/" + item.location + "/" + item.id + 
                    	  "' ><div class='thumb'>&nbsp;<img src='/Mangosteen/audio.png' alt='" + item.title + "'/>&nbsp;</div></a><p>" + (item.title != null && item.title.length > 20 ? item.title.slice(0,20) : item.title);
                ...
                {
                    html += "<li><a href='/Mangosteen/browse/media/" + item.type + "/" + item.location+ "/" + item.id + "'>" + item.title + "</a></li>";
                }
            }
