...
public class DoHead extends AbstractMethod {
    ...
    public void executeOverlapped(ITransaction transaction, HttpServletRequest req, HttpServletResponse resp)
      throws IOException, LockFailedException
    {
    }
    
    // IMethodExecutor 인터페이스 구현한 AbstractMethod 상속.... execute 실행
