...
public interface IWebdavStore {
     ...
     *      if something goes wrong on the store level
     */
   String getChildrenNums(ITransaction paramITransaction, String paramString);
     ...
     * @return StoredObject
     */
 boolean renameObject(ITransaction paramITransaction, String paramString1, String paramString2);
